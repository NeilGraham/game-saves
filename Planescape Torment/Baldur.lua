...
SetPrivateProfileString('Program Options','Volume Movie','12')
...
SetPrivateProfileString('Game Options','Always Run','0')
...
SetPrivateProfileString('Game Options','Last Save PST','000000012-Mortuary - 2nd Floor - Day 1, Hour 0')
...
SetPrivateProfileString('Game Options','Show Enemy Health Status','0')
